% Script used to generate a static library for the ROS2 dependent model file
...
%   tbritton 20250606 - Changed the rosPackages initialization to be based
%                       on known variant settings
...
buildWithRos(buildDiagram, modelFile, rosPackages);
